        ...
        <div className="glass-strong rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full mt-2 px-4 py-3 rounded-xl bg-gradient-to-r from-teal-500 to-blue-500 text-white font-medium hover:shadow-[0_0_24px_rgba(45,212,191,0.4)] transition-shadow"
            >
              Log In
            </motion.button>
          </form>
